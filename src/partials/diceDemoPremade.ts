const diceDemo = {
  layouts: {
    lg: [
      ...
      { w: 1, h: 1, x: 0, y: 1, i: "EubFsmS5K3", moved: false, static: false },
      { w: 1, h: 1, x: 0, y: 2, i: "MCPIPAmPkS", moved: false, static: false },
    ],
    md: [],
    sm: [],
    xs: [
      ...
      { w: 8, h: 21, x: 0, y: 1, i: "EubFsmS5K3", moved: false, static: false },
    ],
    xxs: [
      {
        w: 1,
      ...
      { w: 4, h: 36, x: 0, y: 1, i: "EubFsmS5K3", moved: false, static: false },
    ],
  },
  widgets: [
    {
